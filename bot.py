    ...
    def do_GET(self):
        try:
            ...
            response_data = {
                ...
                # Real daily PnL from bot engine (accumulated realized PnL)
                "daily_pnl": round(getattr(bot_engine, 'daily_pnl', 0.0), 6),
                ...
                "badge_threshold": getattr(bot_engine, 'badge_threshold', 5),
                "trade_usd_size": getattr(bot_engine, 'trade_usd_size', BASE_TRADE_SIZE),
                # Staircase info (Update 3)
                "staircase_level": getattr(bot_engine, 'staircase_level', 0),
                "staircase_targets": STAIRCASE_TARGETS,
                "safe_mode": getattr(bot_engine, 'safe_mode_active', False),
                "daily_peak_pnl": round(getattr(bot_engine, 'daily_peak_pnl', 0.0), 4),
